...
from .data import airfoil as airfoil
from .data  import no2 as no2
from .data  import time_series as ts
from .data  import communities_and_crime as cc
from .data  import skillcraft as sc
from .data  import dti_dg as dd
from .data  import RCF_MNIST as rfm
